...
3. यदि खरीदार द्वारा आधा भुगतान करने के बाद चैनल में लॉगिन कर लिया जाता है लेकिन चैनल पसंद नहीं आता, तो विक्रेता को भुगतान राशि वापस करनी होगी और उसके बाद ही चैनल का स्वामित्व वापस मिलेगा। यदि विक्रेता 7 दिनों के भीतर ऐसा नहीं करता है, तो चैनल को आगे बेचने का अधिकार सुरक्षित रहेगा।
4. यदि किसी भी पक्ष द्वारा 7 दिनों तक कोई प्रतिक्रिया, संपर्क या उत्तर नहीं दिया जाता है, तो उसके बाद दूसरे पक्ष की कोई जिम्मेदारी नहीं होगी।
5. चैनल खरीदने या बेचने वाले सभी पक्ष इस समझौते में लिखी गई सभी शर्तों को स्वीकार करेंगे और उनका पालन करेंगे।
6. इस समझौते पर दोनों पक्षों के हस्ताक्षर होने के बाद ही इसे वैध माना जाएगा।
7. यदि इस समझौते पर संबंधित पक्षों के हस्ताक्षर नहीं हैं, तो यह समझौता अमान्य और अवैध माना जाएगा।
...
संचालित (Powered by): गौतम तिवारी (Gautam Tiwari)
  ...
  const clauses: Clause[] = [
    ...
    },
    {
      id: 10,
      category: "terms",
      title: "आधा भुगतान, लॉगिन और रिफंड सुरक्षा",
      englishTitle: "Half Payment, Login & Refund Security",
      description: "यदि खरीदार द्वारा आधा भुगतान करने के बाद चैनल में लॉगिन कर लिया जाता है लेकिन चैनल पसंद नहीं आता, तो विक्रेता को भुगतान राशि वापस करनी होगी और उसके बाद ही चैनल का स्वामित्व वापस मिलेगा। यदि विक्रेता 7 दिनों के भीतर ऐसा नहीं करता है, तो चैनल को आगे बेचने का अधिकार सुरक्षित रहेगा।",
      icon: Lock
    },
    {
      id: 11,
                        ...
                        <div className="border-4 border-double border-slate-300 p-6 sm:p-10 rounded-xl bg-white shadow-sm print-card max-w-2xl mx-auto">
                          ...
                          <div className="border-t border-slate-200 pt-6 space-y-3">
                            ...
                            <ul className="space-y-3.5 text-xs text-slate-700 leading-relaxed font-hindi list-decimal pl-4">
                              ...
                              <li>
                                यदि खरीदार द्वारा आधा भुगतान करने के बाद चैनल में लॉगिन कर लिया जाता है लेकिन चैनल पसंद नहीं आता, तो विक्रेता को भुगतान राशि वापस करनी होगी और उसके बाद ही चैनल का स्वामित्व वापस मिलेगा। यदि विक्रेता 7 दिनों के भीतर ऐसा नहीं करता है, तो चैनल को आगे बेचने का अधिकार सुरक्षित रहेगा।
                              </li>
                              <li>
